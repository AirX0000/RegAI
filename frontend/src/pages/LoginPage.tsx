...
const DEMO_ACCOUNTS = [
    { role: 'superadmin', label: '👑 Master SuperAdmin', email: 'superadmin@finbridge.demo', badge: 'Global', color: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100' },
    { role: 'admin', label: 'Admin', email: 'admin@finbridge.demo', badge: 'System', color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100' },
