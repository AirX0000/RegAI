...
def upgrade():
    ...
    # Create transformed_statements table if not exists
    if 'transformed_statements' not in tables:
    ...
    # Create transformation_adjustments table if not exists
    if 'transformation_adjustments' not in tables:
